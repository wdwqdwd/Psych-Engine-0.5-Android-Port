...
function onCreate()
    ...
    makeAnimatedLuaSprite('runningdummy','runninguberkid',-400,700)
    addAnimationByPrefix('runningdummy','run','UberKidRun',24,true)

    makeAnimatedLuaSprite('runningbgdummy','runninguberkid',-560,610)
    ...
    makeAnimatedLuaSprite('stabuberkid','uberkiddeaths',200,520)
    ...
    makeAnimatedLuaSprite('runningbgdummy2','runninguberkidtwo',2800,610)
    ...
    makeAnimatedLuaSprite('fireuberkid','uberkiddeaths',1540,610)
    ...
    makeAnimatedLuaSprite('head','uberheaddeath',0,1400)
    ...
    makeAnimatedLuaSprite('charger','charginguberkid',-300,500)
    ...
    makeAnimatedLuaSprite('charger2','chargertwo',1400,500)
    ...
    makeAnimatedLuaSprite('finalpunch','finalpunch',670,420)
    ...
    makeAnimatedLuaSprite('nene','nene-uber',720,434)
    ...
    makeAnimatedLuaSprite('darnell','darnell-uber',1150,380)
